...
function init() {
    ...
    $('.frame-4 p').html('PICK THE<br>LEADING LOCAL<br>AND WORLD<br>BUSINESS NEWS');
...
function start() {
    ...
    function animatePuppet(){
      tlPuppet
              ...
              //  .to('.puppet-main', 0.15, {ease: Back.easeInOut.config(1.7), rotation: 3, y:"-=10", delay:0.0})
              //  .to('.tie-puppet', 0.15, {ease: Back.easeInOut.config(1.7), rotation:-5 }, "-=0.15")
              //  .to('.puppet-right-leg', 0.15, {ease: Back.easeInOut.config(1.7), rotation:1}, "-=0.15")
              //  .to('.puppet-left-leg', 0.15, {ease: Back.easeInOut.config(1.7), rotation:-1}, "-=0.15")
    ...
    tl.set('.feature', {scale:0.4, x:247, y:-342})
